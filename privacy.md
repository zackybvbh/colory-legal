...
- The progress data is stored in the **application data folder of your own Google Drive**.
- When signed in, we process your **Play Games player ID** and **display name** to show who
  is signed in and to keep the sync tied to the correct account.
...
purchase token and an anonymous app-user identifier to confirm whether your subscription is
...
Section 4; on newer versions no permission is required.
...
- deliver the picture catalog and images;
...
- **On-device data** (progress, settings, custom pictures) remains until you clear it, clear
...
right to access, correct, delete, or restrict processing of your personal data, and to object
to certain processing. To exercise these rights, contact us at **zackysstudio@gmail.com**.
You can also manage ad personalization in your device settings and manage Play Games / Google
Drive data in your Google account.
...
of 13 (or the applicable age in your jurisdiction). We do not knowingly collect personal
information from children. If you believe a child has provided us personal information,
contact us at **zackysstudio@gmail.com** and we will take appropriate steps.
